...
def filter_clst_f_corr_thd(clst_f_corr_dict, fcorr_thd, higher_this_fcorr=True):
    ...
    return picked_clsts, picked_clsts_f_corr_dict

def _run_filter_clsts_gini_ent_hl_fcorr_h(ENV_task, clst_hiera_pkl_name, tis_pct_pkl_name,
    ...
    all_picked = [picked_gini_ent_all, picked_gini_ent_h02, picked_gini_ent_h05,
                  picked_gini_ent_l02, picked_gini_ent_l005,
