...
def filter_singlesldie_topattKtiles(tiles_all_list, slide_tileidxs_list, slide_attscores, K,
    ...
    Args:
        ...
        reverse: if sort the top K tiles with lowest attention value, default = False
...
class LCSB_MIL():
    ...
    def __init__(self, ENV_task, encoder=None, aggregator_name='GatedAttPool', pt_agt_name=None,
        ...
        self.attpool_stop_maintains = self.ENV_task.ATTPOOL_STOP_MAINTAINS if self.pt_agt_name == None else 1
...
#         self.model_filename_tuple = model_filename_tuple
        ...
        self.attpool_stop_loss = self.ENV_task.ATTPOOL_STOP_LOSS if self.pt_agt_name == None else self.ENV_task.ATTPOOL_STOP_LOSS_PT
        self.overall_stop_loss = self.ENV_task.OVERALL_STOP_LOSS if self.pt_agt_name == None else self.ENV_task.OVERALL_STOP_LOSS_PT
