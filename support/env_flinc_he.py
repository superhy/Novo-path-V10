...
ENV_FLINC_HE_STEA = parames_task(
    ...
    debug_mode=False,
    task_name='steatosis_score', # decided the label filename together with the stain_type
...
ENV_FLINC_HE_BALL = parames_task(
    project_name=ENV.PROJECT_NAME,
    scale_factor=ENV.SCALE_FACTOR,
    tile_size=ENV.TILE_H_SIZE,
    tp_tiles_threshold=ENV.TP_TILES_THRESHOLD,
    pil_image_file_format=ENV.PIL_IMAGE_FILE_FORMAT,
    debug_mode=False,
    task_name='ballooning_score',
    server_root='/data/slides/yang_he_ball',
    pc_root='D:/FLINC_dataset/slides/yang_he_ball',
    mac_root='',
    meta_folder_name='FLINC/meta',
    test_part_prop=0.3,
    fold_suffix='-0',
...
ENV_FLINC_HE_BALL_BI = parames_task(
    project_name=ENV.PROJECT_NAME,
    scale_factor=ENV.SCALE_FACTOR,
    tile_size=ENV.TILE_H_SIZE,
    tp_tiles_threshold=ENV.TP_TILES_THRESHOLD,
