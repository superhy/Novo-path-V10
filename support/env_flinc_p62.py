...
ENV_FLINC_P62_U = parames_task(
    ...
    server_root='/data/slides/yang_p62',
    pc_root='D:/FLINC_dataset/slides/yang_p62',
    mac_root='',
...
ENV_FLINC_P62_REG_PT = parames_task(
    project_name=ENV.PROJECT_NAME,
    scale_factor=ENV.SCALE_FACTOR,
    tile_size=2048,
    ...
    vit_shape=9,
    nb_clst=8, # @deprecated
    reg_radius=3, # @deprecated
...
ENV_FLINC_P62_BALL_BI = parames_task(
    ...
    loss_package=('wce', [0.6, 0.4]),
    num_att_epoch=200,
    slidemat_batch_size=16,
    slidemat_dataloader_worker=4,
    num_last_eval_epochs=1,
    reset_optim=False,
    num_round=5,
    tile_batch_size=256,
    tile_dataloader_worker=8,
    ...
    num_inround_t_epoch=5,
    num_inround_rev_t_epoch=2,
    attpool_stop_loss=0.65,
    attpool_stop_maintains=3,
