...
def plot_vit_cls_map(ENV_task, clsmap_pkl_name):
    ...
    '''
    slides_tiles_cls_map_dict = load_map_dict_from_pkl(ENV_task.HEATMAP_STORE_DIR, clsmap_pkl_name)
...
def plot_vit_heads_map(ENV_task, headsmap_pkl_name):
    ...
    '''
    slides_tiles_heads_map_dict = load_map_dict_from_pkl(ENV_task.HEATMAP_STORE_DIR, headsmap_pkl_name)
